...
<head>
    <title>Siraseeds</title>
    <link rel="icon" href="images/rasi/SIRA ICOn 56X56.png" type="image/gif" sizes="56x56">
    <meta content="text/html;charset=utf-8" http-equiv="Content-Type">
    <meta content="width=device-width, initial-scale=1.0" name="viewport" >
    <meta content="Siraseeds.com" name="description" >
    ...
    <link id="colors" href="css/custom.css" rel="stylesheet" type="text/css" >
				...
				<div class="mobile-menu-area d-lg-none">
					<div class="mobile-menu-area-inner" id="scrollbar">
						<ul class="m-menu">
							...
							<li><a class="active" href="#0">Pages</a>
								<ul class="m-submenu">
											...
											<ul class="search-cart">
												...
												<li class="cart">
													...
													<div class="cart-content">
														<div class="cart-item">
															<div class="cart-img">
																<a href="#"><img src="assets/images/buycart/01.jpg" alt=""></a>
															</div>
															<div class="cart-des">
														...
														<div class="cart-item">
															<div class="cart-img">
																<a href="#"><img src="assets/images/buycart/02.jpg" alt=""></a>
															</div>
															<div class="cart-des">
																<a href="#">Product Title Hore</a>
																<p>$20.00</p>
                    ...
                    <div class="post-content">
                        ...
                        <div class="breadcamp">
                            <ul class="d-flex flex-wrap justify-content-center align-items-center">
                                ...
                                <li><a class="active">About Page</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="post-item-inner text-center">
                            ...
                            <div class="post-content">
                                <div class="title">
                                    ...
                                    <h5 class="m-0">Milk For Making Ghee</h5>
                                </div>
                                <p>Continually productize compelling quality for 
                                packed with all Elated Themes. Setting up to website
                                and creating pages.</p>
                                        ...
                                        <div class="histori-item">
                                            ...
                                            <div class="histori-content">
                                                ...
                                                <div class="histori-right">
                                                    ...
                                                    compelling quality for packed with all elated themes setting up to website .</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
